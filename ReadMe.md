...
## chapter 3. DSSD 数据处理 
 ...
 - 参考文献
      - [1.Automatic intrinsic calibration of double-sided silicon strip detectors](./chapt3/Automatic intrinsic calibration of double-sided silicon strip detectors.pdf)
