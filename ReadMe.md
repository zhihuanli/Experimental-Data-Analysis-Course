...
# 核物理实验数据处理 课程
## 课程目标：
- 通过若干典型探测器和典型实验场景，理解核物理实验数据从原始信号到物理量重建的基本逻辑，建立实验数据分析的直观认识，掌握常见的数据处理流程，并具备根据具体课题进一步细化、验证和发展分析方法的能力；不试图系统覆盖所有核物理实验分析技术，而是通过典型案例展示实验数据分析的一般思路、关键环节和工作流程，为后续将相关方法迁移到具体实验问题中奠定基础。
